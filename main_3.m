...
disp("Exact Values for Lift Coefficent and Induced Drag Coefficient")
disp("Exact Cl:" + c_L_exact)
disp("Exact CDi:" + c_Di_exact)
...
disp("Table Comparing Number of Terms Required to Approximate Cl, Cdi to given error limits")
disp(Part3_Table2)
...
c_L_01 = plot_c_L3(end);
c_Di_01 = plot_c_Di3(end);
q_inf = 0.5*rho*V^2;
Lift = c_L_01*(q_inf*S);
D_i = c_Di_01*(q_inf*S);
...
modes = plot_ND3;
Part3_Table2 = table(modes, Lift, D_i);
% Part3_Table2 = renamevars(Part3_Table2, "Var1", "N");
% Part3_Table2 = renamevars(Part3_Table2, "Var2", "C_L");
% Part3_Table2 = renamevars(Part3_Table2, "Var3", "C_Di");
